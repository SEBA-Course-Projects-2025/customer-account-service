...
// @Summary      List orders
// @Description  Returns a paginated list of orders for the given customer.
// @Tags         orders
// @Accept       json
// @Produce      json
...
// @Success      200 {array} dtos.GetOrdersResponse
// @Failure      400 {object} map[string]interface{} "Invalid query parameters or customerId"
...
func (h *OrderHandler) GetOrdersHandler(c *gin.Context) {
	...
	queryParams := dtos.OrderQueryParams{
		Limit:     limit,
		Offset:    offset,
		SortBy:    sortBy,
		SortOrder: sortOrder,
	...
	orders, err := services.GetOrders(c.Request.Context(), h.OrderRepo, queryParams, customerId)
