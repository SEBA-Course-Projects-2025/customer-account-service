...
// @Failure      400 {object} map[string]interface{} "Invalid customerId, orderId, or request body"
...
func (h *OrderHandler) PatchOrderStatusHandler(c *gin.Context) {
	...
	order, err := services.PatchOrderStatus(c.Request.Context(), h.OrderRepo, statusReq, orderId, customerId)
	if err != nil {
